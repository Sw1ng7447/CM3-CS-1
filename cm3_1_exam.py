...
"""Do this by writing multiple functions that call each other. These will be `strip_punctuation(text)`, `make_words(text)`, and `count_occurrence(words)`. The final output should be a dictionary with keys the words, and values the number of times they happened in the speech. Which was MLK Jrs most used word?"""
